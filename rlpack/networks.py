...
from rlpack.modules import LayerNorm
...
class ArgmaxDiscretePolicy(Mlp):
    def __init__(
            self,
            **kwargs
    ):
    ...
    def forward(self, obs, deterministic=False):
        ...
        """
        action_probabilities = super().forward(obs)
        if deterministic:
        ...
        return action, action_probabilities, log_action_probabilities
